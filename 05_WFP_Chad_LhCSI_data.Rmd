---
title: "WFP datasets wrangling - Chad : Stratégies d'adaptation aux moyens d'existence (LhCSI)"
...
```{r 05 setup, include=FALSE, results = 'hide'}
...
```{r 05 remove environment variables}

rm(list = ls())
```

```{r 05 environment settings}
...
```{r 05 read harmonization excel file}
...
```{r 05 select and rename columns needed}
