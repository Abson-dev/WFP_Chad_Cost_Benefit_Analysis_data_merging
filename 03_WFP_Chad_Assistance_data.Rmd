...
```{r 03 setup, include=FALSE, results = 'hide'}
...
```{r 03 remove environment variables}

rm(list = ls())
```

```{r 03 environment settings}
...
```{r 03 read harmonization excel file}
...
```{r 03 select and rename columns needed}
